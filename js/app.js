            ...
            portfolio: [
                {
                    id: 1,
                    title: 'KEYs 關鍵理財網',
                    content: '主要功能財富管理規劃系統，負責後端運算。另有開發保險平台(依據保險缺口找出合適的保險組合)、後台保險商品建檔系統(過去建檔使用人工計算，常有計算數據錯誤導致商品無法正確呈現，透過系統自動計算降低人為疏失)、人生護照畫面(整合系統上原有的小工具)等專案。',
                    imgUrl: 'images/porfolio_holdingkeys.png',
                    demoUrl: 'https://www.holdingkeys.com/HoldingKeys/'
                }, {
                    id: 2,
                    title: 'KEYs 關鍵理財網 首頁',
                    content: '負責header & footer RWD前端切版',
                    imgUrl: 'images/portfolio_keysHeader.png',
                    demoUrl: 'http://test.holdingkeys.com/HoldingKeys/Home/IndexNew'
                }, {
                    id: 3,
